        ...
        <div class="relative pdp-input-area">
            ...
            <div class="relative flex items-center">
                <input @click="showDatepicker = !showDatepicker"
                       class="w-full border border-gray-300 p-2 rounded-[10px] focus:outline-0 h-10 auto-go-to-next pdp-input"
                       type="text" readonly
                ...
                <span x-show="datepickerValue"
                      ...
                      @click="removeDate(); showDatepicker = false">
                        <svg class="w-5 h-5" viewBox="0 0 24 24"><path
        ...
        <div
            ...
            <div class="flex justify-between items-center mb-2">
                <div>
                    ...
                    <span x-text="year" @click="currentView = 'year'" class="ml-1 text-lg text-gray-800 font-normal cursor-pointer"></span>
                </div>
                <div>
                    <button
                            type="button"
                        ...
                        <svg class="h-6 w-6 text-gray-800 inline-flex" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M9 5l7 7-7 7"/>
                        </svg>
